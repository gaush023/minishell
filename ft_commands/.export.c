...
/*   Updated: 2024/09/16 20:41:46 by sagemura         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	insert_new_env(t_mini *mini, char **tokens)
{
	...
	new_env->value = my_calloc(ft_strlen(tokens[1]) + 2, 1, mini->m_node);
	ft_memcpy(new_env->value, tokens[1], ft_strlen(tokens[1]) + 2);
